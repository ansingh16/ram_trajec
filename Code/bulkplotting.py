...
def plot_styling(bx,flag):
    ...
    if(flag=='rstrip'):
            ...
            bx.set_xlabel(r"$\mathbf{R_{c}/R_{vir}}$", fontweight='bold', fontsize=16)
            bx.minorticks_on()
...
def differentM(list1,En):
        ...
        ax1.set_xlabel(r"$\mathbf{R_{c}/R_{vir}}$", fontweight='bold', fontsize=16)
        ...
        ax2.set_xlabel(r"$\mathbf{R_{c}/R_{vir}}$", fontweight='bold', fontsize=16)
...
if __name__ == '__main__':
        ...
        if (type == 'c'):
            ...
            for z in ['z00', 'z05', 'z10']:
                ...
                '''
                M = ['$M = 1 \cdot 10^{10} M_{\odot}$', '$M = 1 \cdot 10^{11} M_{\odot}$', '$M = 1 \cdot 10^{12} M_{\odot}$', \
                    '$M = 1 \cdot 10^{13} M_{\odot}$']
        ...
        if(type=='a'):
            ...
            for z in ['z00']:
                ...
                for th in ['theta00','theta150','theta300']:
                    ...
                    ax[j].plot(dR,dr,'k',linewidth=2.5,label=theta.replace('00','0.0 $^\circ$ '))
                    bx[j].plot(dR,dM,'k',linewidth=2.5,label=theta.replace('00','0.0 $^\circ$ '))
                    #ax[j].set_title(titl[i],fontweight='bold', fontsize=16)
                    #bx[j].set_title(titl[i],fontweight='bold', fontsize=16)

                    ax[j].set_xlim(0.0,2.1)
                    bx[j].set_xlim(0.0, 2.1)
        ...
        if(type=='9'):
            ...
            for redshift in ['0.0','0.5','1.0']:
                ...
                for delt in ['0.1','0.3']:
                    ...
                    ax[k].set_xlabel(r"$\mathbf{R_{c}/R_{vir}}$", fontweight='bold', fontsize=16)
                    ...
                    bx[k].set_xlabel(r"$\mathbf{R_{c}/R_{vir}}$", fontweight='bold', fontsize=16)
