...
class Cluster:
    def __init__(self,para):
        ...
        self._V200 =  (23.4*((self._M_200*self._h/(1.0e8*u.Msun))**(1.0/3.0))*(((self._omega_m*self._Delta_c)/(self._omega_m_z*18.0*(np.pi**2)))**(1.0/6.0))*(((1.0+self._z)/10)**(1.0/2.0))*(u.km/u.second)).to('Mpc/Myr')
    ...
    def RAM_F(self,x1,v1,IGM):
        #print x1,v1
        Ram_f = self.rho_beta(x1,IGM,IGM._C) * v1 * v1
        return Ram_f
